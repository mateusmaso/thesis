...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance = 2cm, auto]
    \node [block] (composeSchema) {Compõe Esquema Unificado};
    \node [cloud, left of=composeSchema] (services) {Serviços};
    \node [block, below of=composeSchema] (buildSchema) {Constrói Esquemas de Serviços};
    \node [block, below of=buildSchema] (wrapSchema) {Extende Esquemas de Serviços};
    \node [block, below of=wrapSchema] (deepExtendSchema) {Extende Esquemas de Serviços};
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}[node distance = 2cm, auto]
    \node [block] (simplifyAST) {Simplifica AST da Consulta};
    \node [cloud, left of=simplifyAST] (services) {Consulta};
    \node [block, below of=simplifyAST] (transformAST) {Transforma em ASTs de Serviços};
    \node [block, below of=transformAST] (reduceASTs) {Reduz ASTs de Serviços};
    \node [block, below of=reduceASTs] (unwrapAST) {Desembrulha ASTs};
