...
% Esse último parágrafo não está bem conectado com os parágrafos anteriores (não falou-se em 'esquema' antes). 
...
\end{figure}
% Essa figura não é citada no texto
...
\end{figure}
% Essas figuras não são citadas no texto
