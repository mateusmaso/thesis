...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \node (film) at (2,6)  {film};
    \node (people) at (-2,8)  {people};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    [scale=.8,auto=left,every node/.style={circle,draw}]
    \node (film) at (0,0)  {film};
    \node (people) at (2,0)  {people};
    \node (planet) at (4,0)  {planet};
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    [scale=.8,auto=left,every node/.style={circle,draw}]
    \node (people) at (0,0)  {people};
    \node (specie) at (2,0)  {specie};
    \node (planet) at (4,0)  {planet};
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \node (film) at (0,0)  {film};
    \node (people) at (2,0)  {people};
    \node (starship) at (4,0) {starship};
    \node (vehicle) at (6,0)  {vehicle};
  \end{tikzpicture}
