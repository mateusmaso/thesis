...
\begin{enumerate}[noitemsep]
  \item \textbf{Construir esquema para serviço}: Serve para ..
  \item \textbf{Envolver campos de um esquema}: Serve para ...
  \item \textbf{Unificar esquemas}: Serve para produzir um esquema unificado, utilizado para interpretar 
  \item \textbf{Simplificar AST}:
  \item \textbf{Transformar AST}:
  \item \textbf{Reduzir ASTs}:
  \item \textbf{Desfazer envoltório de AST}:
  \item \textbf{Buscar de dados}:
  \item \textbf{Criar envoltório}:
  \item \textbf{Unificar dados}:
\end{enumerate}
